...
### 어려웠던 점
 ...
 <p>처음에 이중 for문으로 풀었더니 빅오가 너무 커져 58점밖에 안 나와서 지인에게 또 SOS했다. 이중 for문의 경우 시간초과가 많이 나서 이를 안쓰는 것이 좋다고 하였고 대신 string 클래스의 count 메서드를 추천해주셨다. 그랬더니 for문을 하나만 돌릴 수 있어서 시관 초과 문제 해결할 수 있었다.</p>
